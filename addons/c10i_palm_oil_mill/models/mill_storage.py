...
class mill_storage(models.Model):
    _name           = "mill.storage"
    ...
    def create(self, values):
        ...
        new_location = False
        location = super(mill_storage, self).create(values)
        if location:
    ...
    def write(self, values):
        ...
        return super(mill_storage, self).write(values)
    ...
    def unlink(self):
        ...
        location = super(mill_storage, self).unlink()
        return location
...
class account_abstract_payment(models.AbstractModel):
    ...
    journal_id = fields.Many2one('account.journal', string='Payment Journal', required=True, domain=[('type', 'in', ('bank', 'cash')), ('show_on_list_account', '=', 'True')])
...
class account_payment(models.Model):
    ...
    def _onchange_payment_type(self):
        ...
        res['domain']['journal_id'].append(('type', 'in', ('bank', 'cash')) and ('show_on_list_account', '=', 'True'))
        return res

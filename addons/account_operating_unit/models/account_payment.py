...
class AccountPayment(models.Model):
    ...
    def _create_payment_entry_multi(self, amount, invoice, move, line):
        ...
        print ">>>>>>>>>>>>>>>>>>>>>>>>>>>>partner ct", counterpart_aml_dict['name'], counterpart_aml_dict['account_id'], counterpart_aml_dict['debit'], counterpart_aml_dict['credit'], counterpart_aml_dict['amount_currency'], counterpart_aml_dict['currency_id']
        ...
        if line.payment_difference and line.writeoff_account_id:
            ...
            if line.invoice_id.type in ['in_invoice', 'out_refund']:
                ...
                amount_currency_wo = -1 * amount_currency_wo
            else:
            ...
            print ">>>>>>>>>>>>>>>>>>>>>>>>>>>>writeoff", writeoff_line['name'], writeoff_line['account_id'], line.writeoff_account_id.name, writeoff_line['debit'], writeoff_line['credit'], counterpart_aml_dict['amount_currency'], writeoff_line['currency_id']
            ...
            print "...................xxx 4", line.writeoff_account_id, self.journal_id
            line.reconcile_payment_line(counterpart_aml, writeoff_account=line.writeoff_account_id, writeoff_journal=self.journal_id)
        else:
            # if invoice:

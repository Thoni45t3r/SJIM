...
class jasper_beacukai_laporan_mutasi_live_print(JasperDataParser.JasperDataParser):
    def __init__(self, cr, uid, ids, data, context):
        super(jasper_beacukai_laporan_mutasi_live_print, self).__init__(cr, uid, ids, data, context)
...
jasper_report.ReportJasper('report.beacukai_laporan_mutasi_live_print', 'beacukai.stock.mutation', parser=jasper_beacukai_laporan_mutasi_live_print,)

...
class WeighbridgeScaleMetro(models.Model):
    ...
    state = fields.Selection([('to_create', 'Queue'),
        ('to_update', 'On Progress'),('cannot_be_updated', 'Need Manual Update'),
    ...
    def _sync_timbang_to_picking(self):
        ...
        timbang_to_create = self.search([('create_to_odoo_model','=',True), \
            ...
            ('wb_contract_id','!=',False)], limit=20, order='TIMBANG_OUT_TIMESTAMP asc')
        print ":::::::::::::::::::::::::::::", timbang_to_create
        ...
        for x1 in timbang_to_update_contract:
            new_wb_contract = self.env['weighbridge.contract'].sudo().search([('name','=',x1.TIMBANG_KONTRAK)])

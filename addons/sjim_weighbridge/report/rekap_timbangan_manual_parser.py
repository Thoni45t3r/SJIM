...
class jasper_rekap_timbangan_manual(JasperDataParser.JasperDataParser):
    def __init__(self, cr, uid, ids, data, context):
        super(jasper_rekap_timbangan_manual, self).__init__(cr, uid, ids, data, context)
    ...
    def generate_parameters(self, cr, uid, ids, data, context):
        ...
        params = {
                ...
                'wb_picking_type_id' : data['form']['wb_picking_type_id'][0],
...
jasper_report.ReportJasper('report.report_rekap_timbangan_manual', 'wizard.rekap.timbangan.manual', parser=jasper_rekap_timbangan_manual)

...
class jasper_pr_register_request(JasperDataParser.JasperDataParser):
    def __init__(self, cr, uid, ids, data, context):
        super(jasper_pr_register_request, self).__init__(cr, uid, ids, data, context)
...
jasper_report.ReportJasper('report.report_pr_register_sjm', 'wizard.purchase.received.register', parser=jasper_pr_register_request,)

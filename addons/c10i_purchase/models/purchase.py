...
class PurchaseOrder(models.Model):
    ...
    @api.multi
    def print_report_rounddown(self):
        return {
            'type'          : 'ir.actions.report.xml',
            'report_name'   : 'report_nota_rounddown',
            'datas'         : {
                'model'         : 'purchase.order',
                'id'            : self.id,
                'ids'           : self._context.get('active_ids') and self._context.get('active_ids') or [],
    ...
    @api.multi
    def print_report_nota_purchase_sparepart(self):
        return {
            'type'          : 'ir.actions.report.xml',
            'report_name'   : 'report_nota_purchase_sparepart',
            'datas'         : {
                'model'         : 'purchase.order',
                'id'            : self.id,
                'ids'           : self._context.get('active_ids') and self._context.get('active_ids') or [],
